...
class DeprecationManager:
    ...
    def is_deprecated(self, feature: str) -> bool:
        ...
        if feature in self.deprecations:
            ...
            return deprecation.level in [
                DeprecationLevel.DEPRECATED,
                DeprecationLevel.SUNSET,
            ]
        return False
    ...
    def get_sunset_features(self) -> List[str]:
        ...
        return [
            feature for feature in self.deprecations.keys() if self.is_sunset(feature)
        ]
    ...
    def decorator(func: Callable) -> Callable:
        def wrapper(*args, **kwargs):
            ...
            if deprecation_manager:
                deprecation_manager.check_deprecation(
                    feature, args[0] if args else None
                )
