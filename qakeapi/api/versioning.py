...
class APIVersionManager:
    ...
    def add_strategy(
        self, strategy_type: VersionStrategy, strategy: VersionStrategyInterface
    ):
    ...
    def extract_version(
        self, request: Any, strategy: Optional[VersionStrategy] = None
    ) -> str:
...
class VersionManagerFactory:
    ...
    @staticmethod
    def create_path_based_manager(
        versions: List[str], default_version: str = "v1"
    ) -> APIVersionManager:
    ...
    @staticmethod
    def create_header_based_manager(
        versions: List[str], default_version: str = "v1"
    ) -> APIVersionManager:
    ...
    @staticmethod
    def create_multi_strategy_manager(
        versions: List[str], default_version: str = "v1"
    ) -> APIVersionManager:
