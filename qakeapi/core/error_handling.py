...
class ErrorLogger:
    ...
    def __init__(
        ...
        self.sensitive_headers = {
            ...
            "x-access-token", "x-csrf-token", "set-cookie"
        }
...
class ErrorResponseBuilder:
    ...
    def _build_http_exception_response(self, context: ErrorContext) -> Response:
        ...
        if self.include_error_id:
            ...
            content["request_id"] = context.error_id  # Для соinместandмостand с тестамand
    ...
    def _build_generic_exception_response(self, context: ErrorContext) -> Response:
        ...
        message = self.custom_error_messages.get(
            status_code,
    ...
    async def handle_exception(
        ...
        if custom_handler:
            try:
                ...
                await self.logger.log_error(ErrorContext(
                    error_id=str(uuid.uuid4()),
                    request=request,
...
def create_error_handler(
    ...
    try:
        ...
        error_handler.add_exception_handler(ValidationError, ValidationErrorHandler.handle)
    except ImportError:
        pass
