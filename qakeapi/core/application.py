...
class QakeAPI(APIRouter):
    ...
    def __init__(
        ...
        self.exception_handlers.setdefault(QakeAPIException, self._qakeapi_exception_handler)
    ...
    async def _http_exception_handler(self, request: Request, exc: HTTPException) -> Response:
    ...
    async def _qakeapi_exception_handler(self, request: Request, exc: QakeAPIException) -> Response:
    ...
    async def _generic_exception_handler(self, request: Request, exc: Exception) -> Response:
                ...
                if method_lower in ["get", "post", "put", "delete", "patch", "options", "head"]:
                    ...
                    if route.handler and callable(route.handler):
                        try:
                            ...
                            if self.debug:
                                print(f"Error analyzing parameters for {route.path}: {e}")
                            pass
