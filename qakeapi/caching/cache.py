...
class RedisCache(CacheBackend):
    ...
    def __init__(self, redis_url: str = "redis://localhost:6379", prefix: str = "qakeapi:"):
        self.prefix = prefix
        try:
            import redis.asyncio as redis
            self.redis = redis.from_url(redis_url)
        except ImportError:
            raise ImportError("Для andспользоinанandя RedisCache устаноinandте redis: pip install redis")
