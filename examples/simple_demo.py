...
async def create_item(request: Request):
    ...
    if not isinstance(data.get("price"), (int, float)) or data["price"] <= 0:
        raise HTTPException(status.BAD_REQUEST, "Поле 'price' должно быть положительным числом")
        ...
        "data": [
            {
                ...
                "description": f"Подробное описание элемента {i} с большим количеством текста " * 5,
