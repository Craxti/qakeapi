...
from qakeapi.security.rate_limiting import RateLimiter, RateLimitRule, InMemoryRateLimiter
...
class TestPasswordManager:
    ...
    def test_password_strength_validation(self):
        ...
        manager.validate_password_strength(strong_password)  # Не должно вызывать исключение
