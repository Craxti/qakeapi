...
class TestEnhancedDocumentation:
    ...
    def test_enhanced_openapi_generator(self):
        ...
        # Add parameter
        generator.add_parameter("test_param", {
            "name": "test",
            "in": "query",
            "schema": {"type": "string"}
        })
        ...
        # Add response
        generator.add_response("TestResponse", {
    ...
    def test_websocket_docs_multiple_endpoints(self):
        ...
        ws_doc1 = WebSocketDocumentation(
            path="/ws/test1",
            description="Test WebSocket 1",
            events=[event1]
        )
        
        ws_doc2 = WebSocketDocumentation(
            path="/ws/test2",
            description="Test WebSocket 2",
            events=[event2]
        )
    ...
    def test_openapi_schema_with_components(self):
        ...
        generator.add_security_scheme("bearerAuth", SecurityScheme(
            type=SecuritySchemeType.HTTP,
            name="Authorization",
            scheme="bearer"
        ))
        ...
        generator.add_example("user_example", "User", "User example", {
            "id": 1,
            "name": "John Doe"
        })
        
        generator.add_parameter("user_id", {
            "name": "user_id",
            "in": "path",
            "required": True,
            "schema": {"type": "integer"}
        ...
        generator.add_response("UserResponse", {
        ...
        assert path_data["responses"]["200"]["$ref"] == "#/components/responses/UserResponse"
