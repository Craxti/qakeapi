...
class TestEventBus:
    ...
    async def test_publish_event(self, event_bus, handler):
        ...
        event = Event(type=EventType.DOMAIN, name="test.event", data={"key": "value"})
...
class TestEventStore:
    ...
    async def test_replay_events(self, event_store):
        ...
        event1 = Event(type=EventType.DOMAIN, name="test.event", data={"key": "value1"})

        event2 = Event(type=EventType.DOMAIN, name="test.event", data={"key": "value2"})
...
class TestInMemoryEventStorage:
    ...
    async def test_get_events_with_filters(self, storage):
        ...
        event2 = Event(id="event2", type=EventType.SYSTEM, name="system.startup")
