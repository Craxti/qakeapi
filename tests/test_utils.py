...
class TestStaticFiles:
    ...
    def setup_method(self):
        ...
        (self.static_dir / "style.css").write_text(
            "body { color: red; }", encoding="utf-8"
        )
        (self.static_dir / "script.js").write_text(
...
class TestSimpleTemplates:
    ...
    def setup_method(self):
        ...
        (self.templates_dir / "no_vars.html").write_text(
            "<html><body><h1>Static Template</h1></body></html>", encoding="utf-8"
        )
    ...
    def test_render_template(self):
        ...
        result = templates.render(
            "simple.html", {"title": "Test Title", "content": "Test Content"}
        )
    ...
    def test_template_response(self):
        ...
        response = templates.TemplateResponse(
            "simple.html", {"title": "Response Title", "content": "Response Content"}
        )
    ...
    def test_template_response_with_status(self):
        ...
        response = templates.TemplateResponse(
            "no_vars.html", status_code=201, headers={"X-Custom": "value"}
        )
