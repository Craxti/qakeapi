...
class TestVersionManagerFactory:
    ...
    def test_create_header_based_manager(self):
        ...
        assert isinstance(manager.strategies[VersionStrategy.HEADER], HeaderVersionStrategy)
    
    def test_create_multi_strategy_manager(self):
        """Test creating multi-strategy manager."""
        manager = VersionManagerFactory.create_multi_strategy_manager(["v1", "v2"], "v1")
...
class TestVersioningMiddleware:
    ...
    def setup_method(self):
        """Set up test fixtures."""
        self.manager = VersionManagerFactory.create_multi_strategy_manager(["v1", "v2"], "v1")
...
class TestVersioningMiddlewareFactory:
    ...
    def test_create_versioning_middleware(self):
        ...
        middleware = VersioningMiddlewareFactory.create_versioning_middleware(self.manager)
    ...
    def test_create_compatibility_middleware(self):
        ...
        middleware = VersioningMiddlewareFactory.create_compatibility_middleware(self.manager)
    ...
    def test_create_analytics_middleware(self):
        ...
        middleware = VersioningMiddlewareFactory.create_analytics_middleware(self.manager)
...
class TestIntegration:
    ...
    async def test_complete_versioning_flow(self):
        ...
        middleware_stack = VersioningMiddlewareFactory.create_full_versioning_stack(self.manager)
